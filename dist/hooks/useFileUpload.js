...
function useFileUpload(_a) {
    var _this = this;
    var _b = _a.maxFiles, maxFiles = _b === void 0 ? 24 : _b, onAddFiles = _a.onAddFiles;
    var _c = (0, react_1.useState)(false), isUploading = _c[0], setIsUploading = _c[1];
    var _d = (0, react_1.useState)([]), files = _d[0], setFiles = _d[1];
    var addFiles = function (newFiles) { return __awaiter(_this, void 0, void 0, function () {
        var validFiles;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    validFiles = newFiles.filter(function (file) { return !(0, fileValidation_1.validateFile)(file); });
                    if (!onAddFiles) return [3 /*break*/, 4];
                    setIsUploading(true);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, onAddFiles(validFiles)];
                case 2:
                    _a.sent();
